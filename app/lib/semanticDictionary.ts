...
export const SEMANTIC_DICTIONARY: SemanticDictionary = {
  ...
  tecnologia: {
    ...
    'meta plataforma': ['facebook', 'instagram', 'empresa de zuckerberg', 'mark zuckerberg'],
    'whatsapp': ['zap', 'zapzap', 'app de mensagens'],
  ...
  esportes: {
    ...
    'brasileirão': ['campeonato brasileiro', 'serie a do brasileiro', 'brasileirao'],
