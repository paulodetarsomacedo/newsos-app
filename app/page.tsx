...
{/* 4. BASE PREMIUM OPTICAL GLASS: Ferramentas flutuando sobre a grade */}
      <div className="shrink-0 flex flex-row items-stretch gap-4 px-4 -mt-3 w-full">
        ...
        <div className="optical-glass w-[310px] xl:w-[320px] shrink-0 h-[115px] px-5 py-4 flex items-center justify-between cursor-pointer group" onClick={() => onOpenPodNews && onOpenPodNews()}>
