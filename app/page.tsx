    ...
    {(loadingState === 'extracting' || loadingState === 'analyzing') && (
      <div className="absolute inset-0 z-50 flex flex-col items-center justify-center bg-black p-8">
        ...
        <div className="w-full max-w-sm space-y-6">
          <LoadingStep title="Estabelecendo conexão neural segura..." isActive={loadingState === 'extracting'} isComplete={false} />
          <LoadingStep title="Extraindo e sanitizando dados-fonte..." isActive={loadingState === 'analyzing'} isComplete={loadingState !== 'extracting'} />
          <LoadingStep title="Processando dados com IA..." isActive={false} isComplete={false} />
          <LoadingStep title="Sintetizando briefing de inteligência..." isActive={false} isComplete={false} />
        </div>
