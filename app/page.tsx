...
const generateBriefingFallback = async (news, apiKey) => {
    ...
    try {
const response = await fetch(`https://generativelanguage.googleapis.com/v1beta/models/gemini-1.5-flash-latest:generateContent?key=${apiKey}`, {            body: JSON.stringify({
